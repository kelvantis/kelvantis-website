  ...
  const T = {
    nl: {
      ...
      pricing: {
        ...
        f: { sub: 'Eenmalige investering · Prijs op aanvraag', desc: 'De perfecte start. Een professionele website die presteert, converteert en gevonden wordt door jouw ideale klanten.', f1: 'Conversiegerichte website (t/m 8 pagina\'s)', f2: 'GEO/AEO-optimalisatie', f3: 'Contactformulier met e-mailnotificaties', f4: 'Google Search Console', f5: 'Mobiel geoptimaliseerd', f6: 'Core Web Vitals score 90+', f7: 'AI chatbot', f8: 'Marketing automations', f9: 'CRM-koppeling' },
      ...
      faq: {
        ...
        q2: 'Hoe lang duurt het om live te gaan?', a2: 'De doorlooptijd hangt af van de scope. Een Foundation project is doorgaans snel klaar; een volledig Growth System met AI chatbot, automations en CRM-koppeling vraagt meer tijd. We werken gefaseerd en houden je via vaste updates op de hoogte van de voortgang.',
        ...
        q4: 'Wat is het verschil tussen Foundation en Growth System?', a4: 'Foundation geeft je een professionele, snelle website met GEO/AEO-optimalisatie en een contactformulier, een solide basis. Growth System gaat verder: je krijgt daar bovenop een AI chatbot, automatische lead nurturing, CRM-koppeling en marketing automations die 24/7 voor je werken. Foundation is perfect als start; Growth System is voor wie maximaal wil groeien op autopilot.',
    ...
    en: {
      ...
      pricing: {
        ...
        cta: 'Request quote',
        f: { sub: 'One-time investment · Price on request', desc: 'The perfect start. A professional website that performs, converts and gets found by your ideal clients.', f1: 'Conversion-focused website (up to 8 pages)', f2: 'GEO/AEO optimisation', f3: 'Contact form with email notifications', f4: 'Google Search Console', f5: 'Mobile optimised', f6: 'Core Web Vitals score 90+', f7: 'AI chatbot', f8: 'Marketing automations', f9: 'CRM integration' },
      ...
      faq: {
        ...
        q2: 'How long does it take to go live?', a2: 'Timeline depends on scope. A Foundation project is typically quick to complete; a full Growth System with AI chatbot, automations and CRM integration takes more time. We work in phases and keep you updated with fixed progress reports.',
        ...
        q4: 'What\'s the difference between Foundation and Growth System?', a4: 'Foundation gives you a professional, fast website with GEO/AEO optimisation and a contact form, a solid foundation. Growth System goes further: you also get an AI chatbot, automatic lead nurturing, CRM integration and marketing automations working 24/7. Foundation is perfect to start; Growth System is for those who want to grow on autopilot.',
